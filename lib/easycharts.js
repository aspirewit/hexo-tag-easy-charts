...
var snippet = '<script src="https://unpkg.com/echarts@3.3.2/dist/echarts.min.js"></script>';
...
var chartTag = function(type, args, content) {
  ...
  if (option['series'] && option['series'].length > 0) {
    ...
    var html = `
      <div id="${tagId}" class="hexo-tag-easy-charts" style="width: 100%; height: 480px;"></div>
